...
[![backend-ci](https://img.shields.io/github/actions/workflow/status/trustlab-dev/blackbar/backend-ci.yml?branch=main&label=backend-ci&logo=github)](https://github.com/trustlab-dev/blackbar/actions/workflows/backend-ci.yml)
[![frontend-ci](https://img.shields.io/github/actions/workflow/status/trustlab-dev/blackbar/frontend-ci.yml?branch=main&label=frontend-ci&logo=github)](https://github.com/trustlab-dev/blackbar/actions/workflows/frontend-ci.yml)
[![container](https://img.shields.io/github/actions/workflow/status/trustlab-dev/blackbar/container.yml?branch=main&label=container&logo=docker)](https://github.com/trustlab-dev/blackbar/actions/workflows/container.yml)
[![Latest release](https://img.shields.io/github/v/release/trustlab-dev/blackbar?include_prereleases&sort=semver)](https://github.com/trustlab-dev/blackbar/releases)
...
<!--
Codecov badges are intentionally
